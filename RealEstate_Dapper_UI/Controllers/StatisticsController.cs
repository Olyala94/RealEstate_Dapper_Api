...
namespace RealEstate_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44327/api/Statistics/ActiveEmployeeCount");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44327/api/Statistics/ApartmentCount");
            ...
            var responseMessage11 = await client11.GetAsync("https://localhost:44327/api/Statistics/EmployeeNameByMaxProductCount");
