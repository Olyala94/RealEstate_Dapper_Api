...
namespace RealEstate_Dapper_UI.ViewComponents.HomePage
{
    public class _DefaultWhoWearComponentPartial : ViewComponent
    {
        ...
        public _DefaultWhoWearComponentPartial(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44327/api/Services");
